  ...
  return (
    <div className="bg-card rounded-lg shadow-sm p-4 flex flex-wrap items-end gap-4">
      ...
      <div className="space-y-1">
        ...
        <select value={filterProduto} onChange={(e) => onFilterProdutoChange(e.target.value)} className={selectClass}>
          <option value="">Todos</option>
      ...
      <div className="space-y-1">
        ...
        <select value={filterMotivo} onChange={(e) => onFilterMotivoChange(e.target.value)} className={selectClass}>
          <option value="">Todos</option>
